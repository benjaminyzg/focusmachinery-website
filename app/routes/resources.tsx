  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 font-sans text-slate-800">
      ...
      <div className="mb-12 border-b border-slate-100 pb-6">
        <h2 className="text-sm font-bold text-purple-600 uppercase tracking-wider">Resource Center</h2>
      ...
      <section id="publication" className="scroll-mt-20 mb-16">
        <h2 className="text-2xl font-black text-slate-900 mb-4 border-l-4 border-purple-600 pl-3">Publications & Technical Papers</h2>
      ...
      <section id="procurement" className="scroll-mt-20 mb-16">
        <h2 className="text-2xl font-black text-slate-900 mb-4 border-l-4 border-purple-600 pl-3">Procurement & Supplier Guidelines</h2>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
          ...
          <button className="text-purple-600 font-semibold text-xs hover:underline">View Procurement Portal &rarr;</button>
        </div>
      </section>

      {/* 3. SUSTAINABILITY SECTION */}
      <section id="sustainability" className="scroll-mt-20 mb-16">
        <h2 className="text-2xl font-black text-slate-900 mb-4 border-l-4 border-purple-600 pl-3">Sustainability & Environmental Roadmap</h2>
      ...
      <section id="knowledge-base" className="scroll-mt-20 mb-16">
        <h2 className="text-2xl font-black text-slate-900 mb-4 border-l-4 border-purple-600 pl-3">Knowledge Base & FAQ</h2>
      ...
      <section id="virtual-tours" className="scroll-mt-20 mb-8">
        <h2 className="text-2xl font-black text-slate-900 mb-4 border-l-4 border-purple-600 pl-3">Virtual Tours & Product Previews</h2>
        ...
        <div className="aspect-video w-full max-w-3xl bg-slate-100 rounded-2xl border border-slate-200 flex flex-col justify-center items-center text-center p-6">
          <div className="w-16 h-16 rounded-full bg-purple-100 flex items-center justify-center mb-4 text-purple-600 text-xl font-bold">▶</div>
          ...
          <button className="mt-4 bg-purple-600 text-white text-xs font-semibold px-4 py-2 rounded-lg hover:bg-purple-700">Launch Interactive Tour</button>
        </div>
      </section>
