  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <section className="space-y-4">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Background & Introduction</h3>
      ...
      <section className="space-y-3">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Our Story</h3>
        <p className="text-slate-600 leading-relaxed">
      ...
      {/* Our History */}
      <section className="space-y-4">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Our History</h3>
      ...
      {/* Our Leadership */}
      <section className="space-y-4">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Our Leadership</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Our Board of Directors</h3>
      ...
      {/* Our Accreditation */}
      <section className="space-y-4">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Our Accreditation</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Frequently Asked Questions</h3>
